        ...
        <div className="container projects-section">
          ...
          <div className="project-box half-height">
            ...
            <div className="project-top-content">
              <img src={csharpImg} alt="Profile" className="profile-img" />

              <div className="project-description">
                <p>
                  End-to-end modern backend with middleware, dependency injection, Entity Framework Core, secure authentication, payment processing (Stripe), and deployment. Demonstrates strong architectural skills, scalable design, and real-world app features.
                </p>
              </div>

              <div className="github-link">
                <a
                  href="https://https://github.com/obakengshepherd/capstone-aspnet-enterprise"
                  target="_blank"
                  rel="noreferrer"
