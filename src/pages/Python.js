        ...
        <div className="container projects-section">
          ...
          <div className="project-box half-height">
            ...
            <div className="project-top-content">
              <img src={pythonImg} alt="Profile" className="profile-img" />

              <div className="project-description">
                <p>
                  Combines Django CRUD, authentication, REST APIs (Django REST Framework), deployment, plus AI integration such as conversational chatbots or text/image generation using OpenAI APIs. Shows backend mastery, API design, security, and AI/ML application.
                </p>
              </div>

              <div className="github-link">
                <a
                  href="https://github.com/obakengshepherd/capstone-django-ai"
                  target="_blank"
                  rel="noreferrer"
